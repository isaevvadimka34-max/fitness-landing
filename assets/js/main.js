...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const tariffPlans = [
    ...
    },
    {
      ...
      badge: 'ДЛЯ ВЫПУСКНИЦ',
      highlight: '',
      description: 'Возвращение в систему для выпускниц курса',
      price: 'до −50%',
      oldPrice: '',
      ...
      features: [
        ...
        '−50% на Angels Club для участниц прошлых\u00a0потоков',
        '−30% на Private Club для выпускниц',
      ],
      note: 'Напиши в Telegram: проверим прошлую покупку и отправим ссылку на оплату со скидкой',
      chips: [],
    ...
    },
    {
      ...
      highlight: '',
      description: 'Материалы курса для самостоятельной работы',
      price: '1 990 ₽',
      oldPrice: '2 390 ₽',
      ...
      note: 'Без чата и тренировок: только полезные материалы для самостоятельной работы',
      chips: [],
